...
error_reporting(0);
class Jpush {
        // private $app_key = '56f004e3a75ac2f749c22c6f';        //待发送的应用程序(appKey)，只能填一个。
        // private $master_secret = '599b0fe9b3e34da7283e185a';    //主密码
        // private $url = "https://api.jpush.cn/v3/push";      //推送的地址

        private $app_key = '44d1453e915c876b3b3cb530';        //待发送的应用程序(appKey)，只能填一个。
        private $master_secret = '9ab7665b5901cbefd890bd28';    //主密码
        private $url = "https://api.jpush.cn/v3/push";      //推送的地址
        ...
        /**组装需要的参数
            ...
            $receive = array('registration_id'=>array('4312kjklfds2','8914afd2')); //注册ID
                    ...
                    $error_code=$res_arr['error']['code'];             //错误码
                        switch ($error_code) {
                            ...
                            case 1008:
                                ...
                                break;
                            case 1011:
                                $message= '失败(没有满足条件的推送目标,请检查audience)';
                                break;
                            case 1020:
...
/*$receive = array('registration_id'=>array('1507bfd3f7c544274c0'));
//$receive = 'all';
$content = 'Hello World5';
$jpush = new Jpush_send();
$jpush->send_pub($receive,$content,'5','5556');*/
