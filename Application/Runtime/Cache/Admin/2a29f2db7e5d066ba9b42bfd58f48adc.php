        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo U('User/index');?>" class="tip-bottom">用户管理</a>
                    </li>
                    <li>
                        <strong>用户认证</strong>
                    </li>
			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5><i class="fa fa-tasks"></i> 用户认证</h5>
					</div>
					<div class="ibox-content">
						<table class="table table-bordered">
							...
							<tbody>
                                <?php if(is_array($model)): $i = 0; $__LIST__ = $model;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="long-td">
                                        <td><?php echo ($vo["phone"]); ?></td>                               
                                        <td><?php echo ($vo["rname"]); ?></td>
                                        <td><?php if($vo['gender'] == '1'): ?>男<?php elseif($vo['gender'] == '2'): ?>女<?php endif; ?> 
                                        </td>
                                        <td><?php echo ($vo["age"]); ?></td>
                                        <td>
                                            <?php switch($vo['authstatus']): case "2": ?>待审核<?php break;?>
                                                <?php case "3": ?>驳回<?php break; endswitch;?>
                                        </td>
                                        <td><?php echo date('m-d H:i:s',$vo['ctime']);?></td>
                                        <td width="20%">
                                            <a href="<?php echo U('userdetail',array('uid'=>$vo['uid']));?>" class="btn btn-primary">详情</a>
                                            <?php if($vo['authstatus'] == '2'): ?><a href="<?php echo U('userdetail',array('uid'=>$vo['uid'],'showop'=>1));?>" class="btn btn-primary">审核</a><?php endif; ?>
                                        </td>
