			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5><i class="fa fa-tasks"></i> 律师提现</h5>
					</div>
                                ...
                                <?php if(is_array($model)): $i = 0; $__LIST__ = $model;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="long-td">
                                        ...
                                        <td>
                                            <?php switch($vo['status']): case "0": ?>待处理<?php break;?>
                                                <?php case "1": ?>已处理<?php break;?>
                                                <?php case "2": ?>驳回<?php break; endswitch;?>
                                        </td>
                                        <td width="20%">
                                            <a href="<?php echo U('lawyer_draw_detail',array('drawid'=>$vo['drawid']));?>" class="btn btn-primary">详情</a>
                                            <?php if($vo['status'] == '0'): ?><a href="<?php echo U('lawyer_draw_detail',array('drawid'=>$vo['drawid'],'showop'=>1));?>" class="btn btn-primary">审核</a><?php endif; ?>
                                        </td>
