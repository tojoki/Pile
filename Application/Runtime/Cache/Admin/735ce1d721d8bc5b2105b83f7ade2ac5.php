...
.long-td td{
    ...
    <link rel="stylesheet" type="text/css" href="/pile/Public/Admin/js/plugins/datetimepick/css/lq.datetimepick.css"/>
    <style type="text/css">
			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5><i class="fa fa-tasks"></i> 猜你喜欢</h5>
					</div>
						...
						<table class="table table-bordered">
							...
							<tbody>
								<?php if(is_array($data)): $key = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><tr class="long-td">
                                        ...
                                        <?php
 if($vo['cover']){ ?>
                                            <img src="/pile/<?php echo ($vo['cover']); ?>" width="100"/>
                                        <?php
 } ?>
                                        </td>
                                        <td><?php echo (date("Y-m-d H:i:s",$vo["ctime"])); ?></td>
					                    <td class="btns">
                                                <a href="<?php echo U('add',array('id'=>$vo['activity_id']));?>" class="btn-sm btn-primary edit" style='background-color:#1ab394;border-color:#1ab394;color:#FFF;'>
                                                    <i class="fa fa-pencil"></i> 修改
                                                </a>
                                                <a href="javascript:;" data-id="<?php echo ($vo["activity_id"]); ?>" class="btn-sm btn-danger del" style="background-color:#ed5565;border-color:#ed5565;color:#FFF;">
...
<script>
    ...
    <script type="text/javascript" src="/pile/Public/Admin/js/plugins/datetimepick/js/lq.datetimepick.js"></script>
    <script type="text/javascript" src="/pile/Public/Admin/js/plugins/datetimepick/js/selectUi.js"></script>
    <script type="text/javascript">
        $(".del").click(function(){
            var thi= $(this);            
            var id = thi.data("id");
