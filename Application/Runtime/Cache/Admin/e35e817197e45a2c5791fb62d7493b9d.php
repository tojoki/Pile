...
.long-td td{
	text-align: center
        ...
        <link rel="stylesheet" type="text/css" href="/pile/Public/Admin/css/goods/goods.base.css" />
        <script type="text/javascript" src="/pile/Public/Admin/js/plugins/webuploader/webuploader.min.js"></script>
        <link rel="stylesheet" type="text/css" href="/pile/Public/Admin/css/plugins/webuploader/webuploader.css" />

        <script type="text/javascript" src='/pile/Public/Admin/js/plugins/Validform/Validform_v5.3.1_min.js'></script>
        <style type="text/css" src='/pile/Public/Admin/css/plugins/Validform/validform.css'></style>
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" method="post" action="<?php echo U('add');?>" name="basic_validate" id="productForm">
                            ...
                            <input type="hidden" name="id" value="<?php echo ($info['activity_id']); ?>" />
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="row" style="float:left;">
                                        ...
                                        <?php
 if($info['cover']){ ?>
                                            <img src="/pile/<?php echo ($info['cover']); ?>" width="100" />
                                        <?php
 } ?>
                                        </div>
                                    </div>                  
        ...
        <form id="upload_form" method="post"  action="/pile/Admin/Activity/upload" style="display: none;"   enctype="multipart/form-data">
...
<script src="/pile/Public/Admin/js/plugins/validate/jquery.validate.min.js"></script>
<script src='/pile/Public/Admin/js/plugins/laydate/laydate.js' /></script>
<script type="text/javascript" charset="utf-8" src="/pile/Public/Common/Ueditor/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="/pile/Public/Common/Ueditor/ueditor.all.min.js"></script>
<script type="text/javascript" src="/pile/Public/Admin/js/jquery.form.js"></script>
<script type="text/javascript" src="/pile/Public/Admin/js/pagejs/banner.js"></script>
</body>
</html>
