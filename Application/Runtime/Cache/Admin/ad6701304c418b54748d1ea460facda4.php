        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo U('Article/goods');?>" class="tip-bottom">文本管理</a>
                    </li>
                    <li>
                        <strong>温馨提示</strong>
                    </li>
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" datatype="*" nullmsg="请填写名称" name="name" placeholder="标题" class="form-control title" value="<?php echo ($info["title"]); ?>">
                                </div>
                                <input name='id' class='id' value="<?php echo ($info["id"]); ?>" type='hidden'>
                            </div>
                            <!-- <div class="hr-line-dashed"></div>
                            <div class="form-group">
...
<script>
    ...
    <script type="text/javascript">
            ...
            $('#sub').on('click',function(){
                    ...
                    //     return false;
                    // }
                    $.post("<?php echo U('edit');?>",{title:title,id:id},function(data){
                        if(data.status){
                            alert('修改成功');
