...
$(document).ready(function(){
	$("#loginout").click(function(){
        ...
        <div class="row">
            ...
            <div class="col-sm-1">
            <a href="<?php echo U('add_content',array('id'=>$disc_id));?>" class="btn btn-primary btn-sm">添加内容</a>
            </div>
        </div>
        <br/>
		<div class="row">
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5><i class="fa fa-tasks"></i> <?php echo ($disc_name); ?></h5> 
					</div>
					<div class="ibox-content">
						<table class="table table-hover">
							...
							<tbody>
								<?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="long-td">
                                        <td>
                                            <?php if($vo['type'] == 1): ?>cd<?php endif; ?>
                                            <?php if($vo['type'] == 2): ?>dvd<?php endif; ?>
                                            <?php if($vo['type'] == 3): ?>bd<?php endif; ?>
                                        </td>
                                        <td>
                                        <?php
 if ($vo['name']=='') { echo ''; }else{ echo '<span title="'.$vo['name'].'">'.mb_substr($vo['name'],0,80,'utf-8').'...</span>'; } ?>
                                        </td>
...
<script>
    ...
    $(function(){
        var config = {
            point:{
                title:"用户绑定积分变动记录",
                url:"<?php echo U("Admin/User/pointLog",'','');?>",
            },
            money:{
                title:"用户通用积分变动记录",
                url:"<?php echo U("Admin/User/moneyLog",'','');?>",
            },
            process:{
                title:"案例详情",
                url:"<?php echo U("Admin/Bible/detail",'','');?>",
            }
        };
        $(".del").click(function(){
            $href = $(this).data("href");
