...
$(document).ready(function(){
	$("#loginout").click(function(){
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <p class="text-success"><a href="<?php echo U('Index/index');?>" title="返回首页" class="tip-bottom"><i class="fa fa-home"></i> 首页</a> /
                                                <a href="<?php echo U('Admin/User/index');?>" class="tip-bottom">推送管理</a> /
                                                <a href="javascript:;" class="tip-bottom">消息中心</a>
                                            </p>
                                        </li>
                                    </ul>
                                </div>
        ...
        <div class="row">
            <div class="col-sm-1">
                <a href="<?php echo U('add');?>" class="btn btn-primary btn-sm">添加消息</a>
            </div>
        </div>
        <br/>
		<div class="row">
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5><i class="fa fa-tasks"></i> 消息列表</h5>
					</div>
						...
						<table class="table table-bordered">
							...
							<tbody>
								<?php if(is_array($data)): $key = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><tr class="long-td">
                                        ...
                                        <td title="<?php echo ($vo['content']); ?>"><?=mb_substr($vo['content'],0,10,'utf-8').'...'?></td>
                                        <td><?php echo ($vo['type'] == 1 ? '律师端' : '用户端'); ?></td>
					                    <td class="btns">
                                                <a href="<?php echo U('add',array('id'=>$vo['message_id']));?>" class="btn-sm btn-primary btnrcmd">
                                                    <i class="fa fa-pencil"></i> 修改
                                                </a>
                                           <!--      <a href="<?php echo U('applys',array('bid'=>$vo['bid']));?>" class="btn-sm btn-primary">
                                                    参与人
                                                </a> -->
                                                <a href="javascript:;" data-id="<?php echo ($vo["message_id"]); ?>" class="btn-sm btn-primary del">
                                                    删除
                                                </a>
                                        </td>
...
<script>
    ...
    <script type="text/javascript">
        $(".del").click(function(){
            var thi= $(this);            
            var id = thi.data("id");
            layer.confirm('确定删除该消息吗？', {icon: 3}, function(index){
