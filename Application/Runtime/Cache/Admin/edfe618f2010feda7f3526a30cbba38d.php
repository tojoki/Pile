			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form class="form-horizontal" method="post" action="/xj_property/Admin/Advert/home" name="basic_validate" id="myform">
                                                        <?php if(!empty($data)): ?><input name="aid" type="hidden" value="<?php echo ($data["aid"]); ?>"/><?php endif; ?>
                                                        <div class="hr-line-dashed"></div>
							<div class="form-group">
								<label class="col-sm-2 control-label">广告图</label>
                                                                <div class="col-sm-3">
                                                                    <input type="hidden" name="poster" value="<?php echo ($data["poster"]); ?>" id="poster" datatype="*" nullmsg="请上传广告图片" />
                                                                    <input id="photo_file" name="photo_file" type="file" multiple="true" value="" />
								</div>
								<div class="col-sm-2">						
                                                                    <img id="upload_img" src="<?php echo ((isset($data["poster"]) && ($data["poster"] !== ""))?($data["poster"]):'/Public/Admin/img/no_img.jpg'); ?>" style="max-width: 300px;" />
								</div>
							</div>
                                                        <div class="form-group">
								<label class="col-sm-2 control-label">链接地址</label>
								<div class="col-sm-6">
									<input type="text" datatype="*" nullmsg="请填写链接地址" name="links" placeholder="链接地址" class="form-control" value="<?php echo ($data["links"]); ?>">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
                                                        <div class="form-group">
								...
								<div class=" col-sm-2">
									<input type="text" name="showtime" datatype="n" nullmsg="请填写展示时间" errormsg="展示时间格式错误" placeholder="展示时间" class="form-control m-t-none" value="<?php echo ((isset($data["showtime"]) && ($data["showtime"] !== ""))?($data["showtime"]):2); ?>">
								</div>
							</div>
                                                        <div class="hr-line-dashed"></div>
							<div class="form-group">
