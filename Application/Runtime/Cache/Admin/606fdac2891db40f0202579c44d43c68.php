                        ...
                        <div class="panel panel-default">
                            ...
                            <?php if(!empty($info)): ?><input name="id" value="<?php echo ($_GET['id']); ?>" type="hidden" /><?php endif; ?>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" datatype="*" nullmsg="请填写姓名" name="worker_name" id='worker_name' placeholder="姓名" class="form-control worker_name" value="<?php echo ($info["worker_name"]); ?>">
                                        </div>
                                    </div>
                                    <div class="hr"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" datatype="*" nullmsg="请填写电话" name="phone" id='phone' placeholder="电话" class="form-control phone" value="<?php echo ($info["phone"]); ?>">
                                        </div>
                                    </div>
                                    <div class="hr"></div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <?php
 foreach($list1 as $v){ ?>
                                                <option value="<?php echo ($v['service']); ?>"
                                                <?php if($v['service'] == $info['service']): ?>selected<?php endif; ?>
                                                >
                                                    <?php echo ($v['title']); ?>-洗车服务
                                                </option>
                                            <?php
 } foreach($list2 as $v){ ?>
                                                <option value="<?php echo ($v['service']); ?>"
