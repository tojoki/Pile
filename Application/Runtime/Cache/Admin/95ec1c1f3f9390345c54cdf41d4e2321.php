...
$(document).ready(function(){
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="javascript:;" class="tip-bottom">平台管理</a>
                    </li>
                    <li>
                        <strong>服务类型</strong>
                    </li>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" method="post" action="<?php echo U('add1');?>" name="basic_validate" id="productForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                        <input type="text" datatype="*" nullmsg="请填写优惠券名称" placeholder="请输入优惠券名称" value="<?php echo ($info['name']); ?>"  name="name"  class="form-control">
                                </div>
                            </div> -->
 ...
 foreach($placeList as $v){ ?>
                                        <option value="<?php echo ($v['id']); ?>" <?=$info['place_id']==$v['id']?'selected':'';?> ><?php echo ($v["title"]); ?></option>
                                    <?php
 } ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input name='address' class='form-control' type='text' value="<?php echo ($info['address']); ?>" nullmsg="请输入地址">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input name='phone' class='form-control' type='text' value="<?php echo ($info['phone']); ?>" nullmsg="请输入电话">
                                </div>
                            </div>
                                <!-- <div class="hr-line-dashed"></div>
                                    <div class="form-group">
        ...
        <form id="upload_form" method="post"  action="/xj_property/Admin/Service/upload" style="display: none;"   enctype="multipart/form-data">
...
<script type="text/javascript" src="/xj_property/Public/Admin/js/jquery.form.js"></script>
<script type="text/javascript" src="/xj_property/Public/Admin/js/pagejs/service1.js"></script>
</body>
</html>
