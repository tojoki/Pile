...
.long-td td{
	text-align: center
        ...
        <link rel="stylesheet" type="text/css" href="/xj_property/Public/Admin/js/plugins/lightbox2/css/lightbox.min.css" />
    <style type="text/css">
					...
					<div class="ibox-content">
                                            <table class="table table-bordered">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>状态</td>
                                                            <td><?php switch($teacher['authstatus']): case "2": ?>待审核<?php break;?>
...
<script>
    ...
    <script type="text/javascript" src="/xj_property/Public/Admin/js/plugins/lightbox2/js/lightbox.min.js"></script>
    <script type="text/javascript">
    $(function(){
        $(".btn-primary").click(function(){
            ...
            layer.confirm('是否确认要'+authstr+'该条申请？', {icon: 3}, function(index){
                ...
                var memo = $('#memo').val();
                ajax_request({
                   url:'/xj_property/Admin/User/authuser',
                   params:{status:status,memo:memo,applyid:$("#applyid").val()},
                   succshow:true,
                   redirect:'/xj_property/Admin/User/user',
                });
            });
        });
    });
