...
$(document).ready(function(){
	$("#loginout").click(function(){
        ...
        <br />
        <a href="javascript:;" id='add' class="btn btn-primary">添加温馨提示</a>
			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5><i class="fa fa-tasks"></i> 温馨提示</h5>
					</div>
 ...
 echo '<span title="'.$vo['content'].'">'.mb_substr($vo['content'],0,15,'utf-8').'...</span>'; ?>
										...
										<td>
                                            <a href="javascript:;" data-id="<?php echo ($vo["id"]); ?>" class="btn-sm btn-primary edit">
                                                <i class="fa fa-pencil"></i> 修改</a>
											<a href="javascript:;" data-id="<?php echo ($vo["id"]); ?>" class="btn-sm btn-danger del">
