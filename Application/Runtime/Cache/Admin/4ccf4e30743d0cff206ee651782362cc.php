...
$(document).ready(function(){
	$("#loginout").click(function(){
						...
						<ul class="list-group">
                            <li class="list-group-item">
                                <p class="text-success"><a href="<?php echo U('Index/index');?>" title="返回首页" class="tip-bottom"><i class="fa fa-home"></i> 首页</a> /
                                    <a href="<?php echo U('Admin/Order/list1');?>" class="tip-bottom">订单管理</a> /
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <form action="/xj_property/Admin/Order/list1" class="form-inline" method="get">
...
<script>
    ...
    $(function(){
    	...
    	$('.edit').on('click',function(){
    		...
    		location.href='/xj_property/Admin/Order/orderInfo1?oid='+oid;
    	});
        ...
        $('.del').on('click',function(){
        	...
        	layer.confirm('确定删除？', {icon: 3}, function(index){
	            $.ajax({
	                url:'/xj_property/Admin/Order/del1',
	                data:'oid='+oid,
	                type:'post',
