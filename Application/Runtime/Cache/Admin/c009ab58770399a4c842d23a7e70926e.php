						...
						<ul class="list-group">
							<li class="list-group-item">
								<p class="text-success"><a href="<?php echo U('Index/index');?>" title="返回首页" class="tip-bottom"><i class="fa fa-home"></i> 首页</a> /
									<a href="<?php echo U('admin/Index/pwd');?>" class="tip-bottom">修改密码</a></p>
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form class="form-horizontal" method="post" action="<?php echo U('Index/pwd');?>" name="basic_validate" id="basic_validate">
							<div class="form-group">
								<label class="col-sm-2 control-label">账号</label>
								<div class="col-sm-6">
									<input type="text" name="user" value="<?php echo ($user2["user"]); ?>" readonly placeholder="账号" class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								<div class="col-sm-4 col-sm-offset-2">
									...
									<a class="btn btn-white" href="<?php echo U('admin/Index/pwd');?>">取消</a>
								</div>
							</div>
						</form>
					</div>
