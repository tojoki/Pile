...
$(document).ready(function(){
	$("#loginout").click(function(){
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title"><h5>编辑活动</h5>
                                            <div class="ibox-tools">
                                            </div>
                    </div>
                    <div class="ibox-content">
                        <form class="form-horizontal" method="post" action="<?php echo U('add_lawyer');?>" name="basic_validate" id="productForm">

                            <input type="hidden" name="id" value="<?php echo ($info['id']); ?>" />
                            <div class="form-group">
                                <label class="col-sm-2 control-label">活动标题</label>
                                <div class="col-sm-6">
                                        <input type="text" datatype="*" nullmsg="请填写活动标题" placeholder="请输入活动标题" value="<?php echo ($info['title']); ?>"  name="title"  class="form-control">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label><input type="radio" value="0" name="type" <?php if($info['type'] == 0): ?>checked<?php endif; ?> > <i></i> 抢单奖励</label>
                                    <label><input type="radio" value="1" name="type" <?php if($info['type'] == 1): ?>checked<?php endif; ?> > <i></i> 新人奖</label>
                                    </div>  
                                </div>
                                ...
                                <div class="hr-line-dashed"></div>
                                    <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text"  name="starttime" datatype="*" placeholder="请设置开始时间" id="starttime" readonly nullmsg="请设置开始时间" value="<?php if($info) echo date('Y-m-d H:i:s',$info['begin_time']); ?>" class="form-control">
                                            </div>
                                            <div class="col-sm-3">
                                                <input type="text"  name="endtime" datatype="*" placeholder="请设置结束时间" id="endtime" readonly nullmsg="请设置结束时间" value="<?php if($info) echo date('Y-m-d H:i:s',$info['end_time']); ?>"  class="form-control">
                                            </div>
                                    </div>
        ...
        <form id="upload_form" method="post"  action="/xj_property/Admin/Activity/upload" style="display: none;"   enctype="multipart/form-data">
      ...
      var options = {
          ...
          success:function(data) {
            console.log(data);
              if(data.status == 2){
                  $('.my_img').html('');
                  $('input[name="head_img"]').val(data.path);
                  $('.my_img').append('<img style="width: 100px;height: 100px;" src="'+data.path+'" />');
              }
          }
      }
