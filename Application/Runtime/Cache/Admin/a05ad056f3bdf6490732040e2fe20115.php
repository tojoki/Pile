...
$(document).ready(function(){
	$("#loginout").click(function(){
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title"><h5>编辑消息</h5>
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" method="post" action="<?php echo U('add');?>" name="basic_validate" id="productForm">
                            ...
                            <input type="hidden" name="id" value="<?php echo ($info['message_id']); ?>" />
                            <div class="form-group">
                                <label class="col-sm-2 control-label">消息标题</label>
                                <div class="col-sm-6">
                                        <input type="text" datatype="*" nullmsg="请填写消息标题" placeholder="请输入消息标题" value="<?php echo ($info['title']); ?>"  name="title"  class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <label><input type="radio" value="0" name="type" <?php if($info['type'] == 0): ?>checked<?php endif; ?> > <i></i> 用户端</label>
                                    <label><input type="radio" value="1" name="type" <?php if($info['type'] == 1): ?>checked<?php endif; ?> > <i></i> 律师端</label>
                                    </div>  
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                          <textarea class="input" name="content" style="width:100%;height:180px;" datatype="*" nullmsg="请填写消息内容" placeholder="请输入消息内容" data-validate="required:请输入消息内容"><?php echo ($info['content']); ?></textarea>
                                    </div>
                                    <!-- <div class="col-sm-8">
        ...
        <form id="upload_form" method="post"  action="/xj_property/Admin/Message/upload" style="display: none;"   enctype="multipart/form-data">
