                 ...
                 <div class="ibox-content">
                     <table class="table table-hover no-margins">
                         ...
                         <?php if(is_array($users)): $i = 0; $__LIST__ = $users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$u): $mod = ($i % 2 );++$i;?><tr>
                                 ...
                                 <td class="text-navy"> <i class="fa"></i><?php echo tranTime2($u['ctime']);?></td>
             ...
             <div class="ibox float-e-margins">
                 ...
                 <div class="ibox-content">
                     <table class="table table-hover no-margins">
                         ...
                         <tbody>
                         <?php if(is_array($doctors)): $i = 0; $__LIST__ = $doctors;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dt): $mod = ($i % 2 );++$i;?><tr>
                                 <td><?php echo ($dt["nickname"]); ?></td>
                                 <td class="text-navy"> <i class="fa"></i><?php echo tranTime2($dt['ctime']);?></td>
                             </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                         </tbody>
                     </table>
                 </div>
             ...
             <div class="ibox float-e-margins">
                 ...
                 <div class="ibox-content">
                     <table class="table table-hover no-margins">
                         ...
                         <tbody>
                         <?php if(is_array($applys)): $i = 0; $__LIST__ = $applys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ap): $mod = ($i % 2 );++$i;?><tr>
                                 <td><?php echo ($ap["nickname"]); ?></td>
                                 <td class="text-navy"> <i class="fa"></i><?php echo tranTime2($ap['applytime']);?></td>
                             </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                         </tbody>
                     </table>
                 </div>
             ...
             <div class="ibox float-e-margins">
                 ...
                 <div class="ibox-content">
                     <table class="table table-hover no-margins">
                         ...
                         <tbody>
                         <?php if(is_array($feeds)): $i = 0; $__LIST__ = $feeds;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$fd): $mod = ($i % 2 );++$i;?><tr>
                                 <td><?php echo ($fd["txt"]); ?></td>
                                 <td class="text-navy"> <i class="fa"></i><?php echo tranTime2($fd['ctime']);?></td>
                             </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                         </tbody>
                     </table>
                 </div>
             ...
             <div class="ibox float-e-margins">
                 ...
                 <div class="ibox-content">
                     <table class="table table-hover no-margins">
                         ...
                         <tbody>
                         <?php if(is_array($msgs)): $i = 0; $__LIST__ = $msgs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mg): $mod = ($i % 2 );++$i;?><tr>
                                 <td><?php echo ($mg["txt"]); ?></td>
                                 <td class="text-navy"> <i class="fa"></i><?php echo tranTime2($mg['ctime']);?></td>
                             </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                         </tbody>
                     </table>
                 </div>
