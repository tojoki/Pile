					...
					<div class="ibox-content">
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    <td>姓名</td>
                                    <td><?php echo ($teacher["lawyername"]); ?></td>
                                </tr>
                                <tr>
                                    <td>提现金额</td>
                                    <td><?php echo ($teacher["amount"]); ?></td>
                                </tr>
                                <tr>
                                    <td>方式</td>
                                    <td>
                                        <?php if($teacher['type'] == '1'): ?>支付宝
                                            <?php elseif($teacher['type'] == '2'): ?>
                                                微信<?php endif; ?>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>状态</td>
                                    <td>
                                        <?php switch($teacher['status']): case "0": ?>待处理<?php break;?>
                                ...
                                <?php if($showop): ?><tr>
                                        ...
                                        <td>
                                            <form>
                                                <input type='hidden' name='drawid' id='drawid' value="<?php echo ($teacher["drawid"]); ?>"/>
                                            <table class="table">
                                                <tr>
    ...
    $(function(){
        $(".btn-primary").click(function(){
            ...
            layer.confirm('是否确认要'+authstr+'该条申请？', {icon: 3}, function(index){
                ...
                var memo = $('#memo').val();
                ajax_request({
                   url:'/lawyer/Admin/Lawyer/draw_money',
                   params:{status:status,memo:memo,drawid:$("#drawid").val()},
                   succshow:true,
                   redirect:'/lawyer/Admin/Lawyer/withdraw',
                });
            });
        });
    });
