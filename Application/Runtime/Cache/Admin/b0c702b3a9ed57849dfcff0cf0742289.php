            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" method="post" action="<?php echo U('add2');?>" name="basic_validate" id="productForm">
...
<script type="text/javascript" src="/xj_property/Public/Admin/js/jquery.form.js"></script>
<script type="text/javascript" src="/xj_property/Public/Admin/js/pagejs/service2.js"></script>
</body>
</html>
