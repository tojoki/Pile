...
$(document).ready(function(){
 ...
 if($vo['cover']){ ?>
                                        ...
                                        <?php
 if($vo['is_banner']==0){ ?>
                                            <a href="javascript:;" data-id="<?php echo ($vo["notice_id"]); ?>" class="btn-sm btn-primary edit1" style='background-color:#1ab394;border-color:#1ab394;color:#FFF;'>
                                                <i class="fa fa-pencil"></i>设为轮播
                                            </a>
                                        <?php
 }else{ ?>
                                            <a href="javascript:;" data-id="<?php echo ($vo["notice_id"]); ?>" class="btn-sm btn-danger del1" style="background-color:#ed5565;border-color:#ed5565;color:#FFF;">
 ...
 if($vo['is_recommend']==0){ ?>
                                            <a href="javascript:;" data-id="<?php echo ($vo["notice_id"]); ?>" class="btn-sm btn-primary edit2" style='background-color:#1ab394;border-color:#1ab394;color:#FFF;'>
                                                <i class="fa fa-pencil"></i>设为推荐
                                            </a>
                                        <?php
 }else{ ?>
                                            <a href="javascript:;" data-id="<?php echo ($vo["notice_id"]); ?>" class="btn-sm btn-danger del2" style="background-color:#ed5565;border-color:#ed5565;color:#FFF;">
                                                <i class="fa fa-trash-o"></i>取消推荐
                                            </a>
                                        <?php
 } ?>
                                            <a href="<?php echo U('add',array('id'=>$vo['notice_id']));?>" class="btn-sm btn-primary edit" style='background-color:#1ab394;border-color:#1ab394;color:#FFF;'>
                                                <i class="fa fa-pencil"></i> 修改
                                            </a>
                                            <a href="javascript:;" data-id="<?php echo ($vo["notice_id"]); ?>" class="btn-sm btn-danger del" style="background-color:#ed5565;border-color:#ed5565;color:#FFF;">
...
<script>
    ...
    <script type="text/javascript">
        ...
        $(".edit1").click(function(){
            var thi= $(this);            
            var id = thi.data("id");
            $.getJSON('<?php echo U('set_banner','','');?>/id/'+id,function(data){
                layer.msg(data.msg,{skin:"layui-layer-hui",time:1000,end:function(){
                    if(data.status == 0){
                        window.location.reload();
                    }
        ...
        $(".del1").click(function(){
            var thi= $(this);            
            var id = thi.data("id");
            $.getJSON('<?php echo U('unset_banner','','');?>/id/'+id,function(data){
                layer.msg(data.msg,{skin:"layui-layer-hui",time:1000,end:function(){
                    if(data.status == 0){
                        window.location.reload();
                    }
        ...
        $(".edit2").click(function(){
            var thi= $(this);            
            var id = thi.data("id");
            $.getJSON('<?php echo U('set_recommend','','');?>/id/'+id,function(data){
                layer.msg(data.msg,{skin:"layui-layer-hui",time:1000,end:function(){
                    if(data.status == 0){
                        window.location.reload();
                    }
        ...
        $(".del2").click(function(){
            var thi= $(this);            
            var id = thi.data("id");
            $.getJSON('<?php echo U('unset_recommend','','');?>/id/'+id,function(data){
                layer.msg(data.msg,{skin:"layui-layer-hui",time:1000,end:function(){
                    if(data.status == 0){
                        window.location.reload();
                    }
