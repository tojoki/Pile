                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" method="post" action="<?php echo U('add_user');?>" name="basic_validate" id="productForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6"><?php echo (date("Y-m-d H:i:s",$info['ctime'])); ?></div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6"><?php echo ($info['txt']); ?></div>
                            </div>
                            <div class="hr"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                <?php
 for($i=1;$i<=9;$i++){ if($info['pic'.$i]){ ?>
                                        <img src="/xj_property/<?=$info['pic'.$i]?>"><br>
                                <?php
 } } ?>
                                </div>
                            </div>
        ...
        <form id="upload_form" method="post"  action="/xj_property/Admin/System/upload" style="display: none;"   enctype="multipart/form-data">
