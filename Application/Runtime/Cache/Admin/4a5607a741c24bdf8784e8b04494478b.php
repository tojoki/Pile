...
$(document).ready(function(){
	$("#loginout").click(function(){
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <p class="text-success"><a href="<?php echo U('Index/index');?>" title="返回首页" class="tip-bottom"><i class="fa fa-home"></i> 首页</a> /
                                                ...
                                                <a href="javascript:;" class="tip-bottom">用户活动列表</a>
                                            </p>
                                        </li>
                                    </ul>
                                </div>
        ...
        <div class="row">
            <div class="col-sm-1">
                <a href="<?php echo U('add_user');?>" class="btn btn-primary btn-sm">添加活动</a>
            </div>
        </div>
        <br/>
		<div class="row">
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5><i class="fa fa-tasks"></i> 用户活动列表</h5>
					</div>
						...
						<table class="table table-bordered">
							...
							<tbody>
								<?php if(is_array($data)): $key = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><tr class="long-td">
                                        ...
                                        <td><img src="<?php echo ($vo['cover']); ?>" width="120" height="80" /></td>
                                        <td><?php echo ($vo["name"]); ?></td>
                                        <td><?php echo ($vo["amount"]); ?></td>
                                        <td><?php echo (date("Y/m/d H:i:s",$vo["starttime"])); ?></td>
                                        <td><?php echo (date("Y/m/d H:i:s",$vo["deadtime"])); ?></td>
					                    <td class="btns">
                                                <a href="<?php echo U('add_user',array('id'=>$vo['activity_id']));?>" class="btn-sm btn-primary btnrcmd">
                                                    <i class="fa fa-pencil"></i> 修改
                                                </a>
                                           <!--      <a href="<?php echo U('applys',array('bid'=>$vo['bid']));?>" class="btn-sm btn-primary">
                                                    参与人
                                                </a> -->
                                                <a href="javascript:;" data-id="<?php echo ($vo["activity_id"]); ?>" class="btn-sm btn-primary del">
                                                    删除
                                                </a>
                                        </td>
