...
<body class=" bgf8">
	<header class="bar_nav">
		<a class="icon_left fl" onclick="location.href='/lawyer/Home/Setting/address'"></a>
...
<script type="text/javascript">
  ...
  // 		};	
		...
		myGeo.getPoint(address, function(point){
			if (point) {
				$.ajax({
					url:'/lawyer/Home/Setting/addAddress',
					data:'isdefault='+isdefault+'&uname='+uname+'&mobile='+mobile+'&area='+area+'&detail='+detail+'&lng='+point.lng+'&lat='+point.lat,
					type:'post',
